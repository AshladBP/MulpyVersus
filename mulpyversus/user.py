...
class User:
    ...
    def get_character_level(self, characterName : Characters) -> int:
        ...
        """
        if  characterName.value["id"] in self.accountData['server_data']['Characters'] :
            return self.accountData['server_data']['Characters'][characterName.value["id"]]["Mastery"]["Level"]
        else:
            return 
    ...
    def get_character_current_exp(self, characterName : Characters) -> int:
        ...
        """
        print(characterName.value["id"])
        if  characterName.value["id"] in self.accountData['server_data']['Characters'] :
            return self.accountData['server_data']['Characters'][ characterName.value["id"]]["Mastery"]["CurrentXP"]
        else:
            return 0
